...
/**
 * Copie publique des confettis de l'introduction ({@code BrowtherIntroConfetti}, même physique) pour
 * le parrainage : « à vie » atteint au doigt, un code accepté, le cadeau de la porte factice
 * (§ 12.27). ⚠️ Les deux copies évoluent ENSEMBLE : un réglage retouché ici l'est là-bas.
 *
 * <p>La récompense du geste : quand l'interrupteur passe sur ON, une gerbe de confettis tombe du haut
 ...
 */
public final class ReferralConfetti extends View {
    ...
    public ReferralConfetti(Context context) {
        super(context);
