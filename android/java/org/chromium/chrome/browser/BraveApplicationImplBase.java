...
import org.chromium.chrome.browser.browther_analytics.BrowtherSentry;
...
public class BraveApplicationImplBase extends SplitCompatApplication.Impl {
    ...
    public void onCreate() {
        ...
        if (SplitCompatApplication.isBrowserProcess()) {
            // Browther: init Sentry au plus tôt pour catcher les crashes pendant
            // l'init Chromium. No-op si DSN vide ou si Sentry déjà démarré.
            BrowtherSentry.initialize(getApplication());
