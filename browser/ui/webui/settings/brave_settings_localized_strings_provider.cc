...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Pin shortcut page
      ...
      // Browther: Sawtunaa
      {"sawtunaaTitle", IDS_SETTINGS_SAWTUNAA_TITLE},
      {"sawtunaaToggleLabel", IDS_SETTINGS_SAWTUNAA_TOGGLE_LABEL},
      {"sawtunaaToggleDesc", IDS_SETTINGS_SAWTUNAA_TOGGLE_DESC},
      // Browther: Basarunaa
      {"basarunaaTitle", IDS_SETTINGS_BASARUNAA_TITLE},
      {"basarunaaToggleLabel", IDS_SETTINGS_BASARUNAA_TOGGLE_LABEL},
      {"basarunaaToggleDesc", IDS_SETTINGS_BASARUNAA_TOGGLE_DESC},
