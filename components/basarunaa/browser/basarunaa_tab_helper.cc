...
#if BUILDFLAG(IS_ANDROID)
  // Cleanup pending_analyses_ pour éviter des entrées dangling. La reply de
  // BasarunaaTabAnalyzer arrivera après destruction du RFH = no-op côté
  // OnAnalyzeReply (RFH not found).
